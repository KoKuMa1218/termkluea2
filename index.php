        ...
        <div class="game">
            ...
            <div class="grid-container">
                <ul>
                    ...
                    <li><a href="TOFtopup.html" class="col-4 col-md-2 text-center"><img
                                src="img/honkaiimpact3_logo.jpg">
                    ...
                    <li><a href="TOFtopup.html" class="col-4 col-md-2 text-center"><img
                                src="img/raknarok_tac2_logo.png">
                    ...
                    <li><a href="TOFtopup.html" class="col-4 col-md-2 text-center"><img
                                src="img/ApexLegendMobile_logo.jpg">
